...
<body>
    ...
    <section class="breadcumb-area bg-img gradient-background-overlay" style="background-image: url(img/bg-img/contact-us.jpg);">
        <div class="container h-100">
            <div class="row h-100 align-items-center">
                <div class="col-12">
                        ...
                        <div class="medilife-contact-card mb-50">
                            ...
                            <div class="single-contact d-flex align-items-center">
                                ...
                                <div class="contact-meta">
                                    <p>Simec System, Sector # 12, Road # 15, Uttara, Dhaka, Bangladesh </p>
                                </div>
                            </div>
                            ...
                            <div class="single-contact d-flex align-items-center">
                                ...
                                <div class="contact-meta">
                                    <p>Email: rahat203041@gmail.com</p>
                                </div>
                            </div>
