                ...
                <div class="row h-100">
                    <div class="col-12 h-100">
                        <div class="h-100 d-md-flex justify-content-between align-items-center">
                            <p>Welcome to <span>জরুরী সেবা</span> </p>
                                    ...
                                    <ul class="navbar-nav ml-auto">
                                        ...
                                        <li class="nav-item dropdown active">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                                <a class="dropdown-item" href="index.php">Emergency First Aid</a>
                                                <a class="dropdown-item" href="services.php">Emergency Medicine</a>
                                                <a class="dropdown-item" href="offer-box.php">Health Care Guideline</a>
                                                <a class="dropdown-item" href="single-office-box.php">24 Hours Ambulance</a>
                                                <a class="dropdown-item" href="single-office-box.php">Live Chat</a>
                                            </div>        
                                        </li>
                        ...
                        <div class="medilife-contact-card mb-50">
                            ...
                            <div class="single-contact d-flex align-items-center">
                                ...
                                <div class="contact-meta">
                                    <p>Address: House # 11, Road # 7, Uttara, Dhaka, Bangladesh </p>
                                </div>
                            </div>
